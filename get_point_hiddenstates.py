...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-name", type=str, default="/home/xyf/paper/huggingface/model/Meta-Llama-3-8B-Instruct_popqa")
    parser.add_argument("--original-file", type=str, default="/home/xyf/paper/ranking_decoding/output/Meta-Llama-3-8B-Instruct_popqa/llama3_honest_plus_temp_1.2_n_40_llama3_qa_popqa_train_label_processed.json")
    parser.add_argument("--seed", type=int, default=42)
    parser.add_argument("--gpus", type=int, default=3)
    parser.add_argument("--prompt", type=str, default="llama3_honest_plus_point")
