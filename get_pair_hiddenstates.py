...
if __name__ == "__main__":
    ...
    parser.add_argument("--original-file", type=str, default="./output/Meta-Llama-3-8B-Instruct_squad_2k/llama3_honest_plus_temp1.0_n40_squad_train_4k_top_pair.json")
    parser.add_argument("--seed", type=int, default=42)
    parser.add_argument("--gpus", type=int, default=1)
    parser.add_argument("--prompt", type=str, default="llama3_honest_plus_pair")
